...
public interface SassLibrary extends Library {
	...
	public interface Sass_Importer_Fn extends Callback {
		Sass_Import_List apply(Pointer url, Pointer cb, Sass_Compiler compiler);
	};
	/** <i>native declaration : src/native/include/sass/functions.h</i> */
	public interface Sass_Function_Fn extends Callback {
		Sass_Value apply(Sass_Value Sass_ValuePtr1, Pointer cb, Sass_Compiler compiler);
	};
	/**
	 ...
	 */
	Sass_Value sass_make_boolean(boolean val);
	/**
	 ...
	 */
	Sass_Value sass_make_string(String val);
	/**
	 ...
	 */
	Sass_Value sass_make_qstring(String val);
	/**
	 ...
	 */
	Sass_Value sass_make_number(double val, String unit);
	/**
	 ...
	 */
	Sass_Value sass_make_color(double r, double g, double b, double a);
	/**
	 ...
	 */
	Sass_Value sass_make_list(SizeT len, int sep);
	/**
	 ...
	 */
	Sass_Value sass_make_map(SizeT len);
	/**
	 ...
	 */
	Sass_Value sass_make_error(String msg);
	/**
	 ...
	 */
	Sass_Value sass_make_warning(String msg);
	/**
	 ...
	 */
	Sass_Value sass_value_op(int op, Sass_Value a, Sass_Value b);
	/**
	 ...
	 */
	Sass_Value sass_value_stringify(Sass_Value a, byte compressed, int precision);
	/**
	 ...
	 */
	int sass_value_get_tag(Sass_Value v);
	/**
	 ...
	 */
	boolean sass_value_is_null(Sass_Value v);
	/**
	 ...
	 */
	boolean sass_value_is_number(Sass_Value v);
	/**
	 ...
	 */
	boolean sass_value_is_string(Sass_Value v);
	/**
	 ...
	 */
	boolean sass_value_is_boolean(Sass_Value v);
	/**
	 ...
	 */
	boolean sass_value_is_color(Sass_Value v);
	/**
	 ...
	 */
	boolean sass_value_is_list(Sass_Value v);
	/**
	 ...
	 */
	boolean sass_value_is_map(Sass_Value v);
	/**
	 ...
	 */
	boolean sass_value_is_error(Sass_Value v);
	/**
	 ...
	 */
	boolean sass_value_is_warning(Sass_Value v);
	/**
	 ...
	 */
	double sass_number_get_value(Sass_Value v);
	/**
	 ...
	 */
	void sass_number_set_value(Sass_Value v, double value);
	/**
	 ...
	 */
	String sass_number_get_unit(Sass_Value v);
	/**
	 ...
	 */
	String sass_string_get_value(Sass_Value v);
	/**
	 ...
	 */
	boolean sass_boolean_get_value(Sass_Value v);
	/**
	 ...
	 */
	double sass_color_get_r(Sass_Value v);
	/**
	 ...
	 */
	double sass_color_get_g(Sass_Value v);
	/**
	 ...
	 */
	double sass_color_get_b(Sass_Value v);
	/**
	 ...
	 */
	double sass_color_get_a(Sass_Value v);
	/**
	 ...
	 */
	SizeT sass_list_get_length(Sass_Value v);
	/**
	 ...
	 */
	int sass_list_get_separator(Sass_Value v);
	/**
	 ...
	 */
	Sass_Value sass_list_get_value(Sass_Value v, SizeT i);
	/**
	 ...
	 */
	void sass_list_set_value(Sass_Value v, SizeT i, Sass_Value value);
	/**
	 ...
	 */
	SizeT sass_map_get_length(Sass_Value v);
	/**
	 ...
	 */
	Sass_Value sass_map_get_key(Sass_Value v, SizeT i);
	/**
	 ...
	 */
	void sass_map_set_key(Sass_Value v, SizeT i, Sass_Value Sass_ValuePtr1);
	/**
	 ...
	 */
	Sass_Value sass_map_get_value(Sass_Value v, SizeT i);
	/**
	 ...
	 */
	void sass_map_set_value(Sass_Value v, SizeT i, Sass_Value Sass_ValuePtr1);
	/**
	 ...
	 */
	Pointer sass_error_get_message(Sass_Value v);
	/**
	 ...
	 */
	Pointer sass_warning_get_message(Sass_Value v);
	/**
	 ...
	 */
	Sass_Importer_List sass_make_importer_list(SizeT length);
	/**
	 ...
	 */
	Sass_Importer_Entry sass_importer_get_list_entry(Sass_Importer_List list, SizeT idx);
	/**
	 ...
	 */
	void sass_importer_set_list_entry(Sass_Importer_List list, SizeT idx, Sass_Importer_Entry entry);
	/**
	 ...
	 */
	Sass_Importer_Entry sass_make_importer(Sass_Importer_Fn importer, double priority, Pointer cookie);
	/**
	 ...
	 */
	Pointer sass_importer_get_cookie(Sass_Importer_Entry cb);
	/**
	 ...
	 */
	Sass_Import_List sass_make_import_list(SizeT length);
	/**
	 ...
	 */
	Sass_Import_Entry sass_make_import_entry(String path, ByteBuffer source, ByteBuffer srcmap);
	/**
	 ...
	 */
	Sass_Import_Entry sass_make_import(String imp_path, String abs_base, ByteBuffer source, ByteBuffer srcmap);
	/**
	 ...
	 */
	Sass_Import_Entry sass_import_set_error(Sass_Import_Entry import$, String message, SizeT line, SizeT col);
	/**
	 ...
	 */
	void sass_import_set_list_entry(Sass_Import_List list, SizeT idx, Sass_Import_Entry entry);
	/**
	 ...
	 */
	Sass_Import_Entry sass_import_get_list_entry(Sass_Import_List list, SizeT idx);
	/**
	 ...
	 */
	String sass_import_get_imp_path(Sass_Import_Entry Sass_Import_Entry1);
	/**
	 ...
	 */
	String sass_import_get_abs_path(Sass_Import_Entry Sass_Import_Entry1);
	/**
	 ...
	 */
	String sass_import_get_source(Sass_Import_Entry Sass_Import_Entry1);
	/**
	 ...
	 */
	String sass_import_get_srcmap(Sass_Import_Entry Sass_Import_Entry1);
	/**
	 ...
	 */
	Pointer sass_import_take_source(Sass_Import_Entry Sass_Import_Entry1);
	/**
	 ...
	 */
	Pointer sass_import_take_srcmap(Sass_Import_Entry Sass_Import_Entry1);
	/**
	 ...
	 */
	SizeT sass_import_get_error_line(Sass_Import_Entry Sass_Import_Entry1);
	/**
	 ...
	 */
	SizeT sass_import_get_error_column(Sass_Import_Entry Sass_Import_Entry1);
	/**
	 ...
	 */
	String sass_import_get_error_message(Sass_Import_Entry Sass_Import_Entry1);
	/**
	 ...
	 */
	void sass_delete_import_list(Sass_Import_List Sass_Import_List1);
	/**
	 ...
	 */
	void sass_delete_import(Sass_Import_Entry Sass_Import_Entry1);
	/**
	 ...
	 */
	Sass_Function_List sass_make_function_list(SizeT length);
	/**
	 ...
	 */
	Sass_Function_Entry sass_make_function(String signature, Sass_Function_Fn cb, Pointer cookie);
	/**
	 ...
	 */
	Sass_Function_Entry sass_function_get_list_entry(Sass_Function_List list, SizeT pos);
	/**
	 ...
	 */
	void sass_function_set_list_entry(Sass_Function_List list, SizeT pos, Sass_Function_Entry cb);
	/**
	 ...
	 */
	String sass_function_get_signature(Sass_Function_Entry cb);
	/**
	 ...
	 */
	Sass_File_Context sass_make_file_context(String input_path);
	/**
	 ...
	 */
	Sass_Data_Context sass_make_data_context(ByteBuffer source_string);
	/**
	 ...
	 */
	int sass_compile_file_context(Sass_File_Context ctx);
	/**
	 ...
	 */
	int sass_compile_data_context(Sass_Data_Context ctx);
	/**
	 ...
	 */
	Sass_Compiler sass_make_file_compiler(Sass_File_Context file_ctx);
	/**
	 ...
	 */
	Sass_Compiler sass_make_data_compiler(Sass_Data_Context data_ctx);
	/**
	 ...
	 */
	int sass_compiler_parse(Sass_Compiler compiler);
	/**
	 ...
	 */
	int sass_compiler_execute(Sass_Compiler compiler);
	/**
	 ...
	 */
	void sass_delete_compiler(Sass_Compiler compiler);
	/**
	 ...
	 */
	void sass_delete_file_context(Sass_File_Context ctx);
	/**
	 ...
	 */
	void sass_delete_data_context(Sass_Data_Context ctx);
	/**
	 ...
	 */
	Sass_Context sass_file_context_get_context(Sass_File_Context file_ctx);
	/**
	 ...
	 */
	Sass_Context sass_data_context_get_context(Sass_Data_Context data_ctx);
	/**
	 ...
	 */
	Sass_Options sass_context_get_options(Sass_Context ctx);
	/**
	 ...
	 */
	Sass_Options sass_file_context_get_options(Sass_File_Context file_ctx);
	/**
	 ...
	 */
	Sass_Options sass_data_context_get_options(Sass_Data_Context data_ctx);
	/**
	 ...
	 */
	void sass_file_context_set_options(Sass_File_Context file_ctx, Sass_Options opt);
	/**
	 ...
	 */
	void sass_data_context_set_options(Sass_Data_Context data_ctx, Sass_Options opt);
	/**
	 ...
	 */
	int sass_option_get_precision(Sass_Options options);
	/**
	 ...
	 */
	int sass_option_get_output_style(Sass_Options options);
	/**
	 ...
	 */
	boolean sass_option_get_source_comments(Sass_Options options);
	/**
	 ...
	 */
	boolean sass_option_get_source_map_embed(Sass_Options options);
	/**
	 ...
	 */
	boolean sass_option_get_source_map_contents(Sass_Options options);
	/**
	 ...
	 */
	boolean sass_option_get_omit_source_map_url(Sass_Options options);
	/**
	 ...
	 */
	boolean sass_option_get_is_indented_syntax_src(Sass_Options options);
	/**
	 ...
	 */
	String sass_option_get_indent(Sass_Options options);
	/**
	 ...
	 */
	String sass_option_get_linefeed(Sass_Options options);
	/**
	 ...
	 */
	String sass_option_get_input_path(Sass_Options options);
	/**
	 ...
	 */
	String sass_option_get_output_path(Sass_Options options);
	/**
	 ...
	 */
	String sass_option_get_plugin_path(Sass_Options options);
	/**
	 ...
	 */
	String sass_option_get_include_path(Sass_Options options);
	/**
	 ...
	 */
	String sass_option_get_source_map_file(Sass_Options options);
	/**
	 ...
	 */
	String sass_option_get_source_map_root(Sass_Options options);
	/**
	 ...
	 */
	Sass_Importer_List sass_option_get_c_headers(Sass_Options options);
	/**
	 ...
	 */
	Sass_Importer_List sass_option_get_c_importers(Sass_Options options);
	/**
	 ...
	 */
	Sass_Function_List sass_option_get_c_functions(Sass_Options options);
	/**
	 ...
	 */
	void sass_option_set_precision(Sass_Options options, int precision);
	/**
	 ...
	 */
	void sass_option_set_output_style(Sass_Options options, int output_style);
	/**
	 ...
	 */
	void sass_option_set_source_comments(Sass_Options options, boolean source_comments);
	/**
	 ...
	 */
	void sass_option_set_source_map_embed(Sass_Options options, boolean source_map_embed);
	/**
	 ...
	 */
	void sass_option_set_source_map_contents(Sass_Options options, boolean source_map_contents);
	/**
	 ...
	 */
	void sass_option_set_omit_source_map_url(Sass_Options options, boolean omit_source_map_url);
	/**
	 ...
	 */
	void sass_option_set_is_indented_syntax_src(Sass_Options options, boolean is_indented_syntax_src);
	/**
	 ...
	 */
	void sass_option_set_indent(Sass_Options options, String indent);
	/**
	 ...
	 */
	void sass_option_set_linefeed(Sass_Options options, String linefeed);
	/**
	 ...
	 */
	void sass_option_set_input_path(Sass_Options options, String input_path);
	/**
	 ...
	 */
	void sass_option_set_output_path(Sass_Options options, String output_path);
	/**
	 ...
	 */
	void sass_option_set_plugin_path(Sass_Options options, String plugin_path);
	/**
	 ...
	 */
	void sass_option_set_include_path(Sass_Options options, String include_path);
	/**
	 ...
	 */
	void sass_option_set_source_map_file(Sass_Options options, String source_map_file);
	/**
	 ...
	 */
	void sass_option_set_source_map_root(Sass_Options options, String source_map_root);
	/**
	 ...
	 */
	void sass_option_set_c_headers(Sass_Options options, Sass_Importer_List c_headers);
	/**
	 ...
	 */
	void sass_option_set_c_importers(Sass_Options options, Sass_Importer_List c_importers);
	/**
	 ...
	 */
	void sass_option_set_c_functions(Sass_Options options, Sass_Function_List c_functions);
	/**
	 ...
	 */
	String sass_context_get_output_string(Sass_Context ctx);
	/**
	 ...
	 */
	int sass_context_get_error_status(Sass_Context ctx);
	/**
	 ...
	 */
	String sass_context_get_error_json(Sass_Context ctx);
	/**
	 ...
	 */
	String sass_context_get_error_text(Sass_Context ctx);
	/**
	 ...
	 */
	String sass_context_get_error_message(Sass_Context ctx);
	/**
	 ...
	 */
	String sass_context_get_error_file(Sass_Context ctx);
	/**
	 ...
	 */
	String sass_context_get_error_src(Sass_Context ctx);
	/**
	 ...
	 */
	SizeT sass_context_get_error_line(Sass_Context ctx);
	/**
	 ...
	 */
	SizeT sass_context_get_error_column(Sass_Context ctx);
	/**
	 ...
	 */
	String sass_context_get_source_map_string(Sass_Context ctx);
	/**
	 ...
	 */
	String[] sass_context_get_included_files(Sass_Context ctx);
	/**
	 ...
	 */
	SizeT sass_context_get_included_files_size(Sass_Context ctx);
	/**
	 ...
	 */
	PointerByReference sass_context_take_included_files(Sass_Context ctx);
	/**
	 ...
	 */
	int sass_compiler_get_state(Sass_Compiler compiler);
	/**
	 ...
	 */
	Sass_Context sass_compiler_get_context(Sass_Compiler compiler);
	/**
	 ...
	 */
	Sass_Options sass_compiler_get_options(Sass_Compiler compiler);
	/**
	 ...
	 */
	SizeT sass_compiler_get_import_stack_size(Sass_Compiler compiler);
	/**
	 ...
	 */
	Sass_Import_Entry sass_compiler_get_last_import(Sass_Compiler compiler);
	/**
	 ...
	 */
	void sass_option_push_plugin_path(Sass_Options options, String path);
	/**
	 ...
	 */
	void sass_option_push_include_path(Sass_Options options, String path);
